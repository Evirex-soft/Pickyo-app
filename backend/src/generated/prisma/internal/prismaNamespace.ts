...
> = {
  ...
  meta: {
    modelProps: 'user' | 'customerProfile' | 'driverProfile' | 'wallet' | 'refreshToken';
    ...
    CustomerProfile: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CustomerProfileCountAggregateOutputType>
            | number;
        };
      };
    };
    DriverProfile: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.DriverProfileCountAggregateOutputType>
            | number;
        };
      };
    };
