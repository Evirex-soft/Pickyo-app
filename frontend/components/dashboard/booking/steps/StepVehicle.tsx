...
export default function StepVehicle() {
    ...
    return (
        <div className="flex flex-col min-h-full animate-in fade-in slide-in-from-right-4 duration-300 p-0 md:p-0">
            ...
            <div className="pt-6 mt-auto shrink-0">
                <button
                    ...
                    className="w-full py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl font-semibold hover:opacity-90 disabled:opacity-50 transition-all"
                >
                    Proceed to Confirm
                </button>
            </div>
